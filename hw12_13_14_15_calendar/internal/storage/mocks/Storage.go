...
func (_m *Storage) Delete(ctx context.Context, id int) error {
...
func (_m *Storage) Get(ctx context.Context, id int) (storage.Event, error) {
	ret := _m.Called(ctx, id)

	var r0 storage.Event
	if rf, ok := ret.Get(0).(func(context.Context, int) storage.Event); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Get(0).(storage.Event)
	}
...
// ListDay provides a mock function with given fields: ctx, date
func (_m *Storage) ListDay(ctx context.Context, date time.Time) ([]storage.Event, error) {
...
// ListMonth provides a mock function with given fields: ctx, date
func (_m *Storage) ListMonth(ctx context.Context, date time.Time) ([]storage.Event, error) {
	ret := _m.Called(ctx, date)
...
// ListWeek provides a mock function with given fields: ctx, date
func (_m *Storage) ListWeek(ctx context.Context, date time.Time) ([]storage.Event, error) {
	ret := _m.Called(ctx, date)
